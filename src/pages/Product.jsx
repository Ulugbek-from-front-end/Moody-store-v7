...
const Product = () => {
  ...
  const [DefaultSelectValue, setDefaultSelectValue] = useState(`SELECT SIZE`)
          ...
          <Row className={`Product__row`}>
            <Col span={16} className="Product__data">
              <Row justify={"space-between"} className={`Product__data-images`}>
                <Col span={11}>
                  <Img
                    className={`Product__imageholder`}
                    src={DataItem.image}
                    alt={`Checked Duvet Cover Set`}
                  />
                </Col>
                ...
                <Col span={24} className={`Product__data-desc`}>
                  ...
                  <ul className={"list-none Product__data-desc__list "}>
                    <li className={`Product__data-desc__item`}>
                      <Flex>
                        Composition —{" "}
                        <Title level={"h3"}> Cotton 50%, Lyocell 50%</Title>
                      </Flex>
                    </li>
            ...
            <Col span={7} className="Product__content">
              ...
              <Title level={"h3"} className={`Product__content-location`}>
                {" "}
                <FaLocationDot /> Not available in stores
              </Title>
